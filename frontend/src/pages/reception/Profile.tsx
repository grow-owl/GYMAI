...
export default function ReceptionProfile() {
  ...
  return (
    <div className="space-y-4 max-w-2xl mx-auto w-full">
      <PageHeader title="My Profile" subtitle="Account information & security" backTo="/reception" />
      ...
      <div className="space-y-4">
        ...
        <Card sweep className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-(--color-text-faint)">{roleLabel}</p>
            </div>
          </div>
        ...
        {/* Organization Info */}
        <Card className="space-y-3">
          <p className="text-xs font-semibold uppercase tracking-wide text-(--color-text-faint)">Gym & Desk Assignment</p>
